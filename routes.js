...
const REDIRECT_URI = 'http://857b83d7.ngrok.io/loggedin'
router.get('/', (req, res) => {
    res.send("Christian is a poopoo head")
})
router.get('/login', (req, res) => {
    const spotifyScopes = ['user-read-playback-state', 'user-read-currently-playing', 'user-modify-playback-state', 'user-read-private', 'user-read-email', 'user-read-birthdate']
